...
Problems it governs. Next up is **extensive validation** of the splitter + distributor across
more books/sections. The **graph tier** — cross-entity `refs`/`references_tactics`, MathVD
fusion, Math-LLM completion — is the next big piece and is **not started**.
