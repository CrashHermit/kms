...
The per-type referencers fill each entity's ``refs`` (a list of ``core.models.Reference`` — a named target,
...
def canonical_batches(entities: list[models.Entity]) -> dict[str, list[dict]]:
