...
class State(TypedDict, total=False):
    ...
    groups related content together; it does not split statements from procedures.

    `statement_ids` carries the first-node ids of every group (real or placeholder
    statement) from the role typer to the statement extractor. `procedure_ids`
