...
This module groups those mentions into reusable PredicateHub concepts while
...
from kms.graph import (
    local_predicate_hubs as graph_predicate_hubs,
)
...
async def _adjudicate_component(
    ...
    logger.info(
        'predicate hub comparisons: %d boundary pairs, %d waves, '
