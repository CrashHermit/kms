...
class LocalProcedureHubResult(BaseModel):
    canonical_name: str = Field(
        description='A concise name for the shared method.'
    )
    description: str = Field(
        description='A standalone canonical description of the shared method.'
    )
...
class LocalProcedureHubNode:
    def __init__(
        self,
        adjudicator: LocalProcedureHubAdjudicator,
        synthesizer: LocalProcedureHubSynthesizer,
    ) -> None:
