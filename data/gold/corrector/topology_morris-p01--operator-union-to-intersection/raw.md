...
Now $B_j \in \mathcal{T}$, for all $j \in J$, and so $\bigcap_{j \in J} B_j \in \mathcal{T}$, since $\mathcal{T}$ is a topology on $Y$. Therefore, by the definition of $\mathcal{T}_1$, $f^{-1}\left(\bigcup_{j \in J} B_j\right) \in \mathcal{T}_1$; that is, $\bigcup_{j \in J} A_j \in \mathcal{T}_1$.
