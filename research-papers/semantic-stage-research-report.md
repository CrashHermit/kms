...
4. **The current evidence base lacks KMS2-domain labels.** Existing tests prove ordering, provenance, schema, and persistence contracts. They do not measure fact precision/recall, triplet support, typed-description fidelity, community purity, or end-to-end cost. `data/training/fact_gold_v5.jsonl` is the available fact-gold starting point, not a complete semantic-stage benchmark.
...
|---:|---|---|---|---|---|---|
| 1 | Establish fact-extraction baseline | Current fact signature, ±400 estimated-token context, no retry | Complete `data/training/fact_gold_v5.jsonl`; stratified manual audit | Exact/normalized fact precision, recall, F1; source support; atomicity; negation, modality, qualifier retention; unsupported-fact rate | Calls, input/output tokens, wall time | Freeze a reproducible baseline and error taxonomy before architecture changes |
| 2 | Compare source-faithful atomic or complexity-aware decomposition | Current one-call-per-block fact extraction | Fact gold plus manual labels for coreference, atomicity, and target-block support | Fact recall and precision by block type/complexity; unsupported implications; entity preservation | Added preprocessing calls/tokens and end-to-end latency | Adopt only if support and recall improve without unacceptable added cost |
...
1. **Freeze and measure the current baseline.** Confirm `fact_gold_v5` sample count, label protocol, and split policy. Add a small stratified manual audit rather than claiming the JSONL is complete.
...
- [Pommeret et al., Atomic Propositions, arXiv 2026](https://arxiv.org/abs/2604.02866)
- [Choi et al., SocraticKG, arXiv 2026](https://arxiv.org/abs/2601.10003)
- [Kim et al., GraphRefine, ACL 2026](https://aclanthology.org/2026.acl-long.1353/)
- [Chepurova et al., Wikontic, EACL 2026](https://aclanthology.org/2026.eacl-long.388/)
- [Xu et al., ATGL, ACL 2026](https://aclanthology.org/2026.acl-long.1603/)
- [Yang and Tan, SegDRE, Findings ACL 2026](https://aclanthology.org/2026.findings-acl.1192/)
- [Anuyah et al., CoDe-KG, EMNLP 2025](https://aclanthology.org/2025.emnlp-main.783/)
- [Huang et al., GraphJudge, EMNLP 2025](https://aclanthology.org/2025.emnlp-main.554/)
- [Yin et al., structured entity matching, Findings NAACL 2025](https://aclanthology.org/2025.findings-naacl.437/)
- [Zhang et al., EP-RSR, Findings NAACL 2025](https://aclanthology.org/2025.findings-naacl.224/)
- [Zhang et al., Rethinking DocRE, NAACL 2025](https://aclanthology.org/2025.naacl-long.319/)
- [Li et al., supervised rationale verification, AAAI 2025](https://ojs.aaai.org/index.php/AAAI/article/view/34631)
- [Dekoninck et al., routing and cascading, ICML 2025](https://proceedings.mlr.press/v267/dekoninck25a.html)
- [SLOT, EMNLP Industry 2025](https://aclanthology.org/2025.emnlp-industry.32/)
